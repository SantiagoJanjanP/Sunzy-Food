...
<div class="container-fluid">
	<div class="row">
        ...
        <div class="col-3 border bg-gradient-primary"><span class="">Food Provider</span></div>
        <div class="col-9 border"><span class="font-weight-bolder"><?= isset($shop_name) ? $vcode.' - '.$shop_name : '' ?></span></div>
        <div class="col-3 border bg-gradient-primary"><span class="">Address</span></div>
            ...
            <div class="d-flex align-items-center p-2">
                ...
                <div class="col-auto flex-shrink-1 flex-grow-1">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="col-auto px-0 flex-shrink-1 flex-grow-1"><p class="m-0 pl-3"><small class="text-primary"></small></p></div>
                    </div>
                </div>
            </div>
        </div>
