...
<div class="container-fluid">
	<div class="row">
        ...
        <div class="col-3 border bg-gradient-primary"><span class="">House Address</span></div>
...
<script>
    $(function(){
        $('#update_status').click(function(){
            uni_modal_second("Update Booking Status - <b><?= isset($code) ? $code : '' ?></b>","orders/update_status.php?id=<?= isset($id) ? $id : '' ?>")
        })
    })
